...
description: Use when the user provides a Remotion animation design document and needs working React/Remotion component code generated. Triggers on design documents with fields like 画面内容, 动效说明, 时长, or any structured animation spec.
---
