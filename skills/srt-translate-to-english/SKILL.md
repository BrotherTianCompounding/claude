---
name: srt-translate-to-english
description: Use when the user provides a Chinese SRT subtitle file and wants it translated to English. Triggers include providing an SRT file path, asking for English subtitles, English translation of subtitles, SRT translation, translate SRT, 翻译字幕, 英文字幕.
---
